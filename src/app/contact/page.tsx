...
import { getPageContent, ContactPageContent } from '@/lib/content'

export default function ContactPage() {
  const content = getPageContent<ContactPageContent>('contact')
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="bg-natural-cream p-8 rounded-lg border border-parchment">
              <h2 className="text-2xl font-bold text-charcoal mb-6">{content.form.headline}</h2>
              <ContactForm />
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {content.faqs.items.map((faq, index) => (
                <div key={index} className="bg-spring-meadow p-6 rounded-lg border border-parchment">
