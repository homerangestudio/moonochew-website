        ...
        <div className="container-width">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p
                className="text-xl md:text-2xl text-living-green leading-relaxed mb-8"
              ...
              <div className="flex flex-wrap gap-4">
                {content?.hero?.stats?.map((stat, index) => (
                  <div
                    key={index}
                    className="bg-natural-cream border border-living-green/20 rounded-xl px-6 py-4"
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto">
            <h2
              ...
              data-tina-field={tinaField(content?.story, 'headline')}
            >
              {content?.story?.headline}
            </h2>

            <div
              className="bg-parchment border border-living-green/30 rounded-2xl p-8 md:p-12 mb-12"
              data-tina-field={tinaField(content?.story, 'quote')}
            >
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              <div className="space-y-6 text-living-green leading-relaxed">
                ...
                <p
                  className="text-xl text-charcoal font-medium"
                  data-tina-field={tinaField(content?.story, 'philosophy')}
                >
        ...
        <div className="container-width">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2
              ...
              data-tina-field={tinaField(content?.values, 'headline')}
            >
              {content?.values?.headline}
            </h2>
            <p
              className="text-lg text-living-green"
              data-tina-field={tinaField(content?.values, 'subheadline')}
            >
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {content?.values?.items?.map((value, index) => (
              <div
                ...
                data-tina-field={tinaField(value)}
              >
            ...
            <div className="aspect-video bg-parchment rounded-2xl overflow-hidden border border-living-green/20">
              {content?.australianMade?.image && (
                <Image
                  ...
                  height={450}
                  className="w-full h-full object-cover"
                  data-tina-field={tinaField(content?.australianMade, 'image')}
                />
              )}
            </div>
            <div>
              <div className="inline-block bg-golden-wattle/10 border border-golden-wattle/30 rounded-full px-6 py-2 mb-6">
                <span
                  className="text-golden-wattle font-semibold"
                  data-tina-field={tinaField(content?.australianMade, 'badge')}
                >
                  {content?.australianMade?.badge}
                </span>
              </div>
              <h2
                className="text-4xl md:text-5xl mb-6"
                data-tina-field={tinaField(content?.australianMade, 'headline')}
              >
      ...
      <section className="section-padding bg-gradient-to-br from-parchment via-natural-cream to-spring-meadow">
        <div className="container-width">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <blockquote
              className="text-3xl md:text-4xl lg:text-5xl font-serif text-living-green leading-relaxed mb-8 italic text-balance"
              data-tina-field={tinaField(content?.vision, 'quote')}
            >
              {content?.vision?.quote}
            </blockquote>
            <div className="h-1 w-24 bg-golden-wattle mx-auto mb-6"></div>
            <p
              className="text-xl text-stone-grey"
              data-tina-field={tinaField(content?.vision, 'tagline')}
            >
